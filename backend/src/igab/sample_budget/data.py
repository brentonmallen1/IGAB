...
_HOUSEHOLD = SampleBudgetSpec(
    ...
    payees=(
        ...
        PayeeSpec("Netflix", default_category="Streaming"),
        PayeeSpec("Spotify", default_category="Streaming"),
        ...
        PayeeSpec("IRS"),
        PayeeSpec("Best Buy"),
        PayeeSpec("Delta Air Lines"),
        PayeeSpec("Beachside Resort"),
        ...
        PayeeSpec("NETFLIX.COM", default_category="Streaming"),
