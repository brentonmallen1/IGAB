...
export function Sidebar() {
  ...
  const onBudgetAccountIds = new Set((accounts ?? []).filter((a) => a.on_budget).map((a) => a.id))
    ...
    >
      ...
      <div className="sidebar__scroll">
        ...
        <nav className="sidebar__nav">
          ...
          {me && (
            <div className="sidebar__whoami" title={`Signed in as ${me.display_name || me.email}`}>
              <UserCircle2 size={16} />
              {!collapsed && (
            ...
            {[
              ...
              return (
                ...
                >
                  ...
                  {acc.uncategorized_count > 0 && <span className="sidebar__account-mini-dot" />}
                </button>
              )
            })}
          </div>
