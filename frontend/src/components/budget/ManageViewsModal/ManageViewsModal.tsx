    ...
    >
      ...
      <section className="manage-list__section">
        <div className="manage-list__section-header">
          ...
          <button type="button" className="manage-list__add-btn" onClick={handleNew}>
            <Plus size={13} />
            New View
          </button>
        </div>
        ...
        {!views || views.length === 0 ? (
          ...
          <div className="manage-list__list">
            {views.map((v) => (
              <div key={v.id} className="manage-list__row">
                <span className="manage-list__name manage-views-modal__view-name">
                  {v.name}
                  {activeViewId === v.id && (
