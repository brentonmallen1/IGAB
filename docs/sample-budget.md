...
- **Emergency Fund** is tagged *Emergency fund* (kept here) and moves $100 a
...
- **General Savings** is tagged *Savings*, kept here, and takes the month's
  leftovers. It moves $200 a month to **Cascade Point HYSA**, which counts as
  savings but is not part of the fund.
- **Investing** (and Health Savings on the full tier) is *Savings*, sent out:
